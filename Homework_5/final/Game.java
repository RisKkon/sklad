...
public class Game {
    ...
    public static void main(String[] args) {
        ...
        while(isGameRunning) {
            ...
            executeFunction(array, chosenFunction);
            printArray(array);
            if (chosenFunction  == 12) {
                isGameRunning   = false;
            }
        }
    }
    ...
    public static void executeFunction(int[] array, int chosenFunction) {
        if (chosenFunction == 1) {
        ...
        if (chosenFunction == 10) {
            reverseArray(array);
        }
        if (chosenFunction == 11) {
            printArray(array);
        }
    }
